export const EVENTS = [
    ...
    },
    {
        ...
        image: 'https://images.unsplash.com/photo-1461896836934-ffe607ba8211?q=80&w=3540&auto=format&fit=crop', // Running track
...
export const ATHLETES = {
    disco: {
        male: [
            { id: 'dm1', name: 'Kristjan Ceh', mark: 71.86, image: 'https://images.unsplash.com/photo-1541252260730-0412e8e2108e?q=80&w=400&auto=format&fit=crop' },
            { id: 'dm2', name: 'Daniel Stahl', mark: 71.40, image: 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&w=400&auto=format&fit=crop' },
            { id: 'dm3', name: 'Mykolas Alekna', mark: 71.00, image: 'https://images.unsplash.com/photo-1461896836934-ffe607ba8211?q=80&w=400&auto=format&fit=crop' },
            { id: 'dm4', name: 'Andrius Gudzius', mark: 69.39, image: 'https://images.unsplash.com/photo-1535131749050-aac1f124c655?q=80&w=400&auto=format&fit=crop' },
            { id: 'dm5', name: 'Sam Mattis', mark: 68.69, image: 'https://images.unsplash.com/photo-1517649763962-0c623066013b?q=80&w=400&auto=format&fit=crop' },
        ],
        female: [
