...
export default function ConfirmationPage() {
    ...
    if (loading) {
        return <div className="min-h-dvh bg-black flex items-center justify-center text-white">Cargando...</div>;
    }

    if (!data) {
        return (
            <div className="min-h-dvh bg-black flex flex-col items-center justify-center text-white px-6 text-center">
    ...
    return (
        <main className="min-h-dvh bg-black overflow-x-hidden relative flex flex-col items-center pt-[calc(env(safe-area-inset-top,0px)+1rem)] pb-[calc(env(safe-area-inset-bottom,0px)+1.5rem)] px-4">
            {/* Background Magic */}
